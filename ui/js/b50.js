/* ── b50 — ── b50 — v3.1 — 카탈로그 폴더 구조 정리 ── (index.html 블록에서 기계적 추출, 동작 불변) */

/* ============================================================
   v3.1 — 카탈로그 폴더 구조 정리
   · 폴더 안에 폴더 (하위 폴더) — 세로 안내선으로 계층이 보인다
   · 폴더 없음 가짜 폴더를 없애고, 폴더에 담기지 않은 항목은
     그룹 바로 아래에 그대로 둔다
   · 끌어다 놓기: 폴더·폴더 영역·그룹 머리말 모두 드롭 대상
   · 검색은 트리를 접고 폴더 경로 + 이름 평면 결과로
   · 이름 변경은 더블클릭, 접기/펼치기는 키보드로도
   ============================================================ */
(function () {
