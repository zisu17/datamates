...
/* 워크스페이스는 파이프라인 묶음으로만 사용한다 */
const WSGROUPS = [
  { id: 'ws_exam', name: '검사 운영', pipes: ['pl_exam', 'pl_patient'] },
  { id: 'ws_checkup', name: '건강검진', pipes: ['pl_checkup'] },
  { id: 'ws_ingest', name: '원천 수집', pipes: ['pl_visit'] },
];
...
HELP.quality = { t: '데이터 품질', items: [
  '대시보드에서 품질 점수와 확인이 필요한 규칙을 봅니다.',
  '규칙 탭에서 전체 검사 규칙과 최근 결과를 관리합니다.',
  '새 규칙으로 검사 유형·대상 모델·컬럼·심각도를 정합니다.',
  '위반 내역에서 규칙 위반을 행 단위로 확인합니다.',
  '규칙은 데이터 모델링의 품질 규칙 탭에서도 수정할 수 있습니다.'] };
