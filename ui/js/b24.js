/* ── b24 — ── b24 — ── v2.3.2 — 배율을 줄여도 항상 끌어서 옮길 수 있게 한다 ── (index.html 블록에서 기계적 추출, 동작 불변) */

/* ── v2.3.2 — 배율을 줄여도 항상 끌어서 옮길 수 있게 한다 ─────────────
   내용이 화면보다 작아지면 스크롤 여유가 없어져 패닝이 먹히지 않았다.
   캔버스 둘레에 여백을 둬 어떤 배율에서도 스크롤 범위가 남게 한다.  */
