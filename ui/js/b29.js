/* ── b29 — ── b29 — v2.4.1 — 관계 화면에 들어왔을 때 ERD 가 빈 여백에 가려지던 문제 ── (index.html 블록에서 기계적 추출, 동작 불변) */

/* ============================================================
   v2.4.1 — 관계 화면에 들어왔을 때 ERD 가 빈 여백에 가려지던 문제
   캔버스 둘레의 여백(ZPAD) 때문에 스크롤 0,0 은 아무것도 없는 자리 다.
   다시 그릴 때마다 보던 위치를 되살리고, 내용이 화면 밖이면 끌어다 놓는다.
   ============================================================ */
